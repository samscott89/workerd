...
struct CachePurgeOptions {
  ...
  jsg::Optional<kj::Array<kj::String>> hosts;
  jsg::Optional<kj::Array<kj::String>> prefixes;
  jsg::Optional<bool> purge_everything;
  JSG_STRUCT(tags, hosts, prefixes, purge_everything);
};
...
class CacheContext: public jsg::Object {
 public:
  ...
  //
  // The TypeHandler params are auto-injected by JSG at dispatch time. They are NOT
  // part of the JS-visible signature.
